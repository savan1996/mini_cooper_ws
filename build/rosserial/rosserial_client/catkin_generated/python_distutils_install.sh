...
echo_and_run cd "/home/mir-lab/mini_cooper_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/mir-lab/mini_cooper_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/mir-lab/mini_cooper_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
