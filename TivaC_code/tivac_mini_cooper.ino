...
#define de_pin_a 31          //pf_4; channel a pin for drive encoder
#define de_pin_b 32          //pd_7; channel b pin for drive encoder
#define se_pin_a 35          //pc_6; channel a pin for steering encoder
#define se_pin_b 34          //pc_7; channel b pin for steering encoder

#define sm_ina 9             //pa_6; channel a for steering motor
#define sm_inb 10            //pa_7; channel b for steering motor
#define sm_pwm 36            //pc_5; pwm for steering motor

#define dm_ina 12            //pa_3; channel a for right drive motor
#define dm_inb 13            //pa_4 channel b for right drive motor
#define dm_pwm 37            //pc_4; pwm for right drive motor
...
{
  String final_data = "";
  final_data += driving_speed_kph;
  final_data.concat(',');
  final_data += steering_pulse_counter ;
  ...
  if(drive_pulse_counter == 600 || drive_pulse_counter == -600)
      {
        ...
        {
          noInterrupts();
          distance_driven = (drive_encoder_revolutions * 3.142 * 235) / 13;                 //in mm
          total_distance_driven = total_distance_driven + distance_driven;                  //in mm
          driving_speed_kph = distance_driven / ((millis() - last_vel_time) * 0.001);       //mm/s
          driving_speed_kph = (driving_speed_kph * 3.6)/1000;                               //in kph
          //Serial.println(driving_speed_kph);
